...
//		}
		...
		if(!(obj instanceof Student other)) return false; // Student 타입이 아니면 false 
		else return this.studentNo == other.studentNo && this.name.equals(other.name);		
//		Student other = (Student) obj;
//		return this.studentNo == other.studentNo && this.name.equals(other.name);		
	}
	
	// 동등 객체를 판단할 때
	// equals()를 재정의하면 hashCode()도 함께 재정이 하는 것이 일반적이므로 함께 구현하는 것이 좋음
	// Objects.hash(...)
