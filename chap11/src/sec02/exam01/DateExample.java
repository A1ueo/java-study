...
public class DateExample {
	...
	public static void main(String[] args) {
		...
		SimpleDateFormat sdf =
				new SimpleDateFormat("yyyy년 MM월 dd일 EEEE, a hh시 mm분 ss초");
		...
		// 각자 테스트
		sdf = new SimpleDateFormat("yy-MM-dd E, HH:mm:ss:SS");
		...
		DateTimeFormatter formatter =
				DateTimeFormatter.ofPattern("yyyy년 MM월 dd일 EEEE, a hh시 mm분 ss초");
