...
public class WriteExample {
	public static void main(String[] args) throws Exception {
		...
		// try 블록이 끝나거나 예외가 발생되는 즉시 자동으로 자원 정리
		// AutoCloseable 인터페이스를 구현한 클래스는 try-with-resources로 자동 종료 가능
		try (OutputStream os2 = new FileOutputStream("C:/Temp/test1_2.db");) {
